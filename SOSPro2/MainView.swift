...
var proA = User(prenom: "Marie", nom: "Dupont", mail : "dupont@gmail.com", motDePasse : "marie23", image:"proAserruriere", distance: 50, enLigne: true, typeUser: TypeCompte(estPro: true, estCertif:true, domaine: "Serrurière", avisClients: listeAvisSerrure, position: CLLocationCoordinate2D(latitude: 48.8577, longitude: 2.43340)),conversations:[])
...
var proD = User(prenom: "Barbara", nom: "Cora",mail: "user3@gmail.com", motDePasse: "ggj", image: "proEelectricienne", distance: 23.0, enLigne: false, typeUser: TypeCompte(estPro: true, estCertif:true, domaine: "Electricienne", avisClients: listeAvisElec, position: CLLocationCoordinate2D(latitude: 39.51967, longitude: 106.42758)), conversations: [])
...
struct MainView: View {
    ...
    var body: some View {
        TabView {
            ...
            Messagerie(profil:loggedUser).tabItem {
